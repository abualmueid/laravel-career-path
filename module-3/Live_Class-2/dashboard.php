            ...
            <nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
                        ...
                        <div class="flex items-center px-2 lg:px-0">
                            <div class="hidden sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="index.php" class="bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium" aria-current="page">Home</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="relative ml-3" x-data="{ open: false }">
                                <div>
                                    <button @click="open = !open" type="button" class="flex rounded-full bg-white text-sm focus:outline-none" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="h-10 w-10 rounded-full" src="" alt="Abu Al Mueid" />
                                        </span>
                                    </button>
                                </div>
                ...
                <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
                    <div class="space-y-1 pt-2 pb-3">
                        <a href="./index.html" class="bg-emerald-700 text-white block rounded-md py-2 px-3 text-base font-medium" aria-current="page">Home</a>
                    </div>
